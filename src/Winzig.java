...
/*
 *
 *          compile : javac Winzig.java
 *              run : java Winzig -ast winzig_test_programs/winzig_01
 *  compile and run : javac Winzig.java; java Winzig -ast winzig_test_programs/winzig_01
 *         test all : javac Winzig.java; java Winzig -test
    ...
    public static void main(String[] args) {
        ...
        switch (flag){
            case  "-ast":
                ...
                System.out.println(program_as_a_string);
...
//                     try {
//                         program_string = readProgram(path);
//                     } catch (IOException e) {
//                         e.printStackTrace();
//                     }
